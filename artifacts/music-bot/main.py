...
HELP_CATEGORIES = [
    ...
    },
    {
        ...
        "fields": [
            ("🎯 Search Prefixes", "<:spotify:1527767944078295070> `sp ` Spotify\n<:ytmusic:1527767881935491212> `yt ` YouTube Music\n<:applemusic:1527767904819482805> `am ` Apple Music"),
...
HELP_COLOR = ACCENT  # matches all other bot embeds
